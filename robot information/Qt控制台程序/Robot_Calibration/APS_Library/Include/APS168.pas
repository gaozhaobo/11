...
type POINT_DATA_EX   =record 
     ...
     u32_dwell:Longword;         //dwell times ( unit: ms ) *Divided by system cycle time.
...
type PNT_DATA=record
    u32_opt:Longword;        // option, [0x00000000,0xFFFFFFFF]
    i32_x:Longint;          // x-axis component (pulse), [-2147483648,2147484647]
    i32_theta:Longint;      // x-y plane arc move angle (0.001 degree), [-360000,360000]
...
type PNT_DATA_2D_F64 = record
     u32_opt    :Longword;        // option, [0x00000000,0xFFFFFFFF]
     f64_x      :double;        // x-axis component (pulse), [-2147483648,2147484647]
     f64_y      :double;        // y-axis component (pulse), [-2147483648,2147484647]
     f64_theta  :double;        // x-y plane arc move angle (0.000001 degree), [-360000,360000]
     f64_acc    :double;        // acceleration rate (pulse/ss), [0,2147484647]
     f64_dec    :double;        // deceleration rate (pulse/ss), [0,2147484647]
     f64_vi     :double;        // initial velocity (pulse/s), [0,2147484647]
     f64_vm     :double;        // maximum velocity (pulse/s), [0,2147484647]
     f64_ve     :double;        // ending velocity (pulse/s), [0,2147484647]
	   f64_sf     :double;		     // s-factor [0.0 ~ 1.0]
  end;
...
const
MAXHEXLIX									=3; //Helix axes is 3.
MAXARC3										=3; //ARC3 axes is 3.
MAXARC2										=2; //ARC2 axes is 2.
...
type LPSTS =record
	 MotionLoopLoading:Longword;
	 HostLoopLoading:Longword;
	 MotionLoopLoadingMax:Longword;
	 HostLoopLoadingMax:Longword;
end;
...
type POS_DATA_2D_F64_RPS=record		//* This structure adds another variable to record what point was be saved
     u32_opt:Longint;        // option, [0x00000000, 0xFFFFFFFF]
...
type PNT_DATA_2D_EXT=record
      u32_opt:Longint;        // option, [0x00000000,0xFFFFFFFF]
      f64_x:Double;          // x-axis component (pulse), [-2147483648,2147484647]
      f64_y:Double;          // y-axis component (pulse), [-2147483648,2147484647]
      f64_theta:Double;      // x-y plane arc move angle (0.000001 degree), [-360000,360000]
	    f64_acc:array[0..3] of Double;        // acceleration rate (pulse/ss), [0,2147484647]
      f64_dec:array[0..3] of Double;         // deceleration rate (pulse/ss), [0,2147484647]
	    crossover:Longint;
	    Iboundary:Longint;		// initial boundary
      f64_vi:array[0..3] of Double;      // initial velocity (pulse/s), [0,2147484647]
	    vi_cmpr:Longint;
      f64_vm:array[0..3] of Double;      // maximum velocity (pulse/s), [0,2147484647]
	    vm_cmpr:Longint;
      f64_ve:array[0..3] of Double;      // ending velocity (pulse/s), [0,2147484647]
	    ve_cmpr:Longint;
	    Eboundary:Longint;		// end boundary
	    f64_dist:Double;		// point distance
	    f64_angle:Double;		// path angle between previous & current point
	    f64_radius:Double;		// point radiua (used in arc move)
	    i32_arcstate:Longint;
	    spt:Longint;			// speed profile type
	    t:array[0..3] of Double;
	  
	// Horizontal & Vertical line flag
	    HorizontalFlag:Longint;
	    VerticalFlag:Longint;
end;
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function APS_get_system_timer( Board_ID:Longint; var Timer:Longint ):Longint;stdcall;
function APS_int_no_to_handle( Int_No:Longint):Longint;stdcall;
	
//Control driver mode [Only for PCI-8254/8]
function APS_get_curr_sys_ctrl_mode( Axis_ID:Longint; var Mode:Longint ):Longint;stdcall;
...
//New Interface
function APS_ptp(  Axis_ID:Longint;  Option:Longint;  Position:Double; var Wait:ASYNCALL):Longint;stdcall;
function APS_ptp_v(  Axis_ID:Longint;  Option:Longint;  Position:Double;  Vm:Double; var Wait:ASYNCALL):Longint;stdcall;
function APS_ptp_all(  Axis_ID:Longint;  Option:Longint;  Position:Double;  Vs:Double;	 Vm:Double; 	Ve:Double;  Acc:Double;	 Dec:Double;  SFac:Double; var Wait:ASYNCALL):Longint;stdcall;
function APS_vel(  Axis_ID:Longint;  Option:Longint;  Vm:Double; var Wait:ASYNCALL):Longint;stdcall;
function APS_vel_all(  Axis_ID:Longint;  Option:Longint;  Vs:Double;  Vm:Double;  Ve:Double;  Acc:Double;	 Dec:Double;  SFac:Double; var Wait:ASYNCALL):Longint;stdcall;
function APS_line(  Dimension:Longint;  var Axis_ID_Array:Longint;  Option:Longint;  var PositionArray:Double;  var TransPara:Double; var Wait:ASYNCALL):Longint;stdcall;
function APS_line_v(  Dimension:Longint;  var Axis_ID_Array:Longint;  Option:Longint;  var PositionArray:Double;  var TransPara:Double;  Vm:Double; var Wait:ASYNCALL):Longint;stdcall;
function APS_line_all(  Dimension:Longint;  var Axis_ID_Array:Longint;  Option:Longint;  var PositionArray:Double;  var TransPara:Double;  Vs:Double;  Vm:Double;  Ve:Double;  Acc:Double; Dec:Double;  SFac:Double; var Wait:ASYNCALL):Longint;stdcall;
function APS_arc2_ca(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  Angle:Double;  var TransPara:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_arc2_ca_v(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  Angle:Double;  var TransPara:Double;  Vm:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_arc2_ca_all(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  Angle:Double;  var TransPara:Double;  Vs:Double;  Vm:Double;  Ve:Double;  Acc:Double;  Dec:Double;  SFac:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_arc2_ce(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var EndArray:Double;  Dir:Double;  var TransPara:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_arc2_ce_v(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var EndArray:Double;  Dir:Double;  var TransPara:Double;  Vm:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_arc2_ce_all(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var EndArray:Double;  Dir:Double;  var TransPara:Double;  Vs:Double;  Vm:Double;  Ve:Double;  Acc:Double;  Dec:Double;  SFac:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_arc3_ca(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var NormalArray:Double;  Angle:Double;  var TransPara:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_arc3_ca_v(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var NormalArray:Double;  Angle:Double;  var TransPara:Double;  Vm:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_arc3_ca_all(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var NormalArray:Double;  Angle:Double;  var TransPara:Double;  Vs:Double;  Vm:Double;  Ve:Double;  Acc:Double;  Dec:Double;  SFac:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_arc3_ce(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var EndArray:Double;  Dir:Double;  var TransPara:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_arc3_ce_v(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var EndArray:Double;  Dir:Double; var TransPara:Double;  Vm:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_arc3_ce_all(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var EndArray:Double;  Dir:Double;  var TransPara:Double;  Vs:Double;  Vm:Double;  Ve:Double;  Acc:Double;  Dec:Double;  SFac:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_spiral_ca(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var NormalArray:Double;  Angle:Double;  DeltaH:Double;  FinalR:Double;  var TransPara:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_spiral_ca_v(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var NormalArray:Double;  Angle:Double;  DeltaH:Double;  FinalR:Double;  var TransPara:Double;  Vm:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_spiral_ca_all(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var NormalArray:Double;  Angle:Double;  DeltaH:Double;  FinalR:Double;  var TransPara:Double;  Vs:Double;  Vm:Double;  Ve:Double;  Acc:Double;  Dec:Double;  SFac:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_spiral_ce(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var NormalArray:Double;  var EndArray:Double;  Dir:Double;  var TransPara:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_spiral_ce_v(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var NormalArray:Double;  var EndArray:Double;  Dir:Double;  var TransPara:Double;  Vm:Double; var Wait:ASYNCALL ):Longint;stdcall;
function APS_spiral_ce_all(  var Axis_ID_Array:Longint;  Option:Longint;  var CenterArray:Double;  var NormalArray:Double;  var EndArray:Double;  Dir:Double;  var TransPara:Double;  Vs:Double;  Vm:Double;  Ve:Double;  Acc:Double;  Dec:Double;  SFac:Double; var Wait:ASYNCALL ):Longint;stdcall;
...
function APS_get_command_counter(  Axis_ID:Longint; var Counter:Longint ):Longint;stdcall;
...
function APS_absolute_arc_move_f(   Dimension:Longint;   var Axis_ID_Array:Longint;   var Center_Pos_Array:Longint;   Max_Arc_Speed:Longint;   Angle:Double ):Longint;stdcall;
function APS_relative_arc_move_f(   Dimension:Longint;   var Axis_ID_Array:Longint;   var Center_Offset_Array:Longint;   Max_Arc_Speed:Longint;   Angle:Double ):Longint;stdcall;
...
function APS_set_int_factorH( Board_ID:Longint;   Item_No:Longint;   Factor_No:Longint;   Enable:Longint ):Longint;stdcall;
...
function APS_manual_latch2( Axis_ID:Longint ):Longint;stdcall;
...
//Cmd buffer setting
function APS_pt_ext_set_do_ch(  Board_ID:Longint;  PtbId:Longint;  Channel:Longint;  OnOff:Longint ):Longint;stdcall;
function APS_pt_ext_set_table_no(  Board_ID:Longint;  PtbId:Longint;  CtrlNo:Longint;  TableNo:Longint ):Longint;stdcall;
...
function APS_get_feeder_status(  GroupId:Longint;  var State:Longint;  var ErrCode:Longint ):Longint;stdcall;
...
function APS_set_feeder_cfg_acc_type(  GroupId:Longint;  Typ:Longint ):Longint;stdcall;
...
function APS_get_system_timer; external 'APS168.dll';
function APS_int_no_to_handle; external 'APS168.dll';
...
function APS_get_curr_sys_ctrl_mode; external 'APS168.dll';
...
function APS_absolute_arc_move_f; external 'APS168.dll';
function APS_relative_arc_move_f; external 'APS168.dll';
...
function APS_set_int_factorH; external 'APS168.dll';
