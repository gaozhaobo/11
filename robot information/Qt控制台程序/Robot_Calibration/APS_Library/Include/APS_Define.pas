...
interface
           ...
           // PointTable, option
					 ...
					 OPT_FORCE_ABORT   :Longint=$00000200;
           ...
           TIG_ENC_IPT_MODE0	 :Longint=		($00);
           TIG_ENC_IPT_MODE1	 :Longint=		($01);
           TIG_ENC_IPT_MODE2	 :Longint=		($02);
           TIG_ENC_IPT_MODE3	 :Longint=		($03);
           TIG_ENC_IPT_MODE4	 :Longint=		($04);
           TIG_ENC_IPT_MODE5	 :Longint=		($05);
           TIG_ENC_IPT_MODE6	 :Longint=		($06);
           TIG_ENC_IPT_MODE7	 :Longint=		($07);
           TIG_ENC_EA_INV0		 :Longint=		($08);
           TIG_ENC_EA_INV1		 :Longint=		($09);
           TIG_ENC_EA_INV2		 :Longint=		($0A);
           TIG_ENC_EA_INV3		 :Longint=		($0B);
           TIG_ENC_EA_INV4		 :Longint=		($0C);
           TIG_ENC_EA_INV5		 :Longint=		($0D);
           TIG_ENC_EA_INV6		 :Longint=		($0E);
           TIG_ENC_EA_INV7		 :Longint=		($0F);
           TIG_ENC_EB_INV0		 :Longint=		($10);
           TIG_ENC_EB_INV1		 :Longint=		($11);
           TIG_ENC_EB_INV2		 :Longint=		($12);
           TIG_ENC_EB_INV3		 :Longint=		($13);
           TIG_ENC_EB_INV4		 :Longint=		($14);
           TIG_ENC_EB_INV5		 :Longint=		($15);
	        TIG_ENC_EB_INV6		 :Longint=		($16);
	        TIG_ENC_EB_INV7		 :Longint=		($17);
	        TIG_ENC_SIGNAL_FILITER_EN0 :Longint=	($28);
	        TIG_ENC_SIGNAL_FILITER_EN1 :Longint=	($29);
	        TIG_ENC_SIGNAL_FILITER_EN2 :Longint=	($2A);
	        TIG_ENC_SIGNAL_FILITER_EN3 :Longint=	($2B);
	        TIG_ENC_SIGNAL_FILITER_EN4 :Longint=	($2C);
	        TIG_ENC_SIGNAL_FILITER_EN5 :Longint=	($2D);
	        TIG_ENC_SIGNAL_FILITER_EN6 :Longint=	($2E);
	        TIG_ENC_SIGNAL_FILITER_EN7 :Longint=	($2F);
	        TIG_TIMER8_DIR		:Longint=		($30);
	        TIG_TIMER8_ITV		:Longint=		($31);
          TIG_CMP0_SRC			:Longint=	($32);
	        TIG_CMP1_SRC			:Longint=	($33);
	        TIG_CMP2_SRC			:Longint=	($34);
	        TIG_CMP3_SRC			:Longint=	($35);
	        TIG_CMP4_SRC			:Longint=	($36);
	        TIG_CMP5_SRC			:Longint=	($37);
	        TIG_CMP6_SRC			:Longint=	($38);
	        TIG_CMP7_SRC			:Longint=	($39);
	        TIG_TRG0_SRC			:Longint=	($3A);
	        TIG_TRG1_SRC			:Longint=	($3B);
          TIG_TRG2_SRC			:Longint=	($3C);
	        IG_TRG3_SRC			:Longint=	($3D);
	        TIG_TRG4_SRC			:Longint=	($3E);
	        TIG_TRG5_SRC			:Longint=	($3F);
	        TIG_TRG6_SRC			:Longint=	($40);
	        TIG_TRG7_SRC			:Longint=	($41);
	        TIG_TRGOUT0_MAP		:Longint=		($42);
	        TIG_TRGOUT1_MAP		:Longint=		($43);
          TIG_TRGOUT2_MAP		:Longint=		($44);
	        TIG_TRGOUT3_MAP		:Longint=		($45);
	        TIG_TRGOUT4_MAP		:Longint=		($46);
	        TIG_TRGOUT5_MAP		:Longint=		($47);
	        TIG_TRGOUT6_MAP		:Longint=		($48);
	        TIG_TRGOUT7_MAP		:Longint=		($49);
    	    TIG_TRGOUT0_LOGIC	 :Longint=		($4A);
	        TIG_TRGOUT1_LOGIC	 :Longint=		($4B);
	        TIG_TRGOUT2_LOGIC	 :Longint=		($4C);
	        TIG_TRGOUT3_LOGIC	 :Longint=		($4D);
	        TIG_TRGOUT4_LOGIC	 :Longint=		($4E);
	        TIG_TRGOUT5_LOGIC	 :Longint=		($4F);
	        TIG_TRGOUT6_LOGIC	 :Longint=		($50);
	        TIG_TRGOUT7_LOGIC	 :Longint=		($51);
    	    TIG_PWM0_PULSE_WIDTH	:Longint=	($52);
	        TIG_PWM1_PULSE_WIDTH	:Longint=	($53);
	        TIG_PWM2_PULSE_WIDTH	:Longint=	($54);
	        TIG_PWM3_PULSE_WIDTH	:Longint=	($55);
	        TIG_PWM4_PULSE_WIDTH	:Longint=	($56);
	        TIG_PWM5_PULSE_WIDTH	:Longint=	($57);
	        TIG_PWM6_PULSE_WIDTH	:Longint=	($58);
	        TIG_PWM7_PULSE_WIDTH	:Longint=	($59);
	        TIG_PWM0_MODE		:Longint=		($5A);
	        TIG_PWM1_MODE		:Longint=		($5B);
	        TIG_PWM2_MODE		:Longint=		($5C);
	        TIG_PWM3_MODE		:Longint=		($5D);
	        TIG_PWM4_MODE		:Longint=		($5E);
	        TIG_PWM5_MODE		:Longint=		($5F);
	        TIG_PWM6_MODE		:Longint=		($60);
	        TIG_PWM7_MODE		:Longint=		($61);
    	    TIG_TIMER0_ITV	 :Longint=			($62);
    	    TIG_TIMER1_ITV	 :Longint=			($63);
    	    TIG_TIMER2_ITV	 :Longint=			($64);
	        TIG_TIMER3_ITV	 :Longint=			($65);
    	    TIG_TIMER4_ITV	 :Longint=			($66);
    	    TIG_TIMER5_ITV	 :Longint=			($67);
	        TIG_TIMER6_ITV	 :Longint=			($68);
	        TIG_TIMER7_ITV	 :Longint=			($69);
	        TIG_FIFO_LEVEL0		:Longint=		($6A);
	        TIG_FIFO_LEVEL1		:Longint=		($6B);
          TIG_FIFO_LEVEL2		:Longint=		($6C);
	        TIG_FIFO_LEVEL3		:Longint=		($6D);
	        TIG_FIFO_LEVEL4		:Longint=		($6E);
	        TIG_FIFO_LEVEL5		:Longint=		($6F);
	        TIG_FIFO_LEVEL6		:Longint=		($70);
	        TIG_FIFO_LEVEL7		:Longint=		($71);
    	    TIG_OUTPUT_EN0		:Longint=		($72);
	        TIG_OUTPUT_EN1		:Longint=		($73);
	        TIG_OUTPUT_EN2		:Longint=		($74);
	        TIG_OUTPUT_EN3		:Longint=		($75);
	        TIG_OUTPUT_EN4		:Longint=		($76);
	        TIG_OUTPUT_EN5		:Longint=		($77);
	        TIG_OUTPUT_EN6		:Longint=		($78);
	        TIG_OUTPUT_EN7		:Longint=		($79);

          PRA_HOME_LATCH		:Longint=		($900);  // Select Home latch source [PCI-8353 only]
					 ...
					 TGR_TCMP0_REUSE    :Longint=$07;   // ECAT-4XMO
					 TGR_TCMP1_REUSE    :Longint=$08;   // ECAT-4XMO
					 TGR_TCMP0_TRANSFER_DONE    :Longint=$09;   // ECAT-4XMO
					 TGR_TCMP1_TRANSFER_DONE    :Longint=$0A;   // ECAT-4XMO
           ...
           PRA_PT_STP_DO_EN    :Longint=$32;  // Disable do when point table stopping.
           
					 PRA_PT_STOP_DO      :Longint=$33;  // Set do value when point table stopping.
					 PRA_PT_STP_DO       :Longint=$33;  // Set do value when point table stopping.
                     ...
                     PRA_EGEAR_MASTER      :Longint=$65;  //  Select gearing master: 0~63
                     PRA_EGEAR_SOURCE      :Longint=$66;  //  Select gearing source // 0: command position deviation1: feedback position deviation
           ...
           PRA_HOME_SHIFT	  :Longint=$17;  // The shift from ORG [PCI-8254/58 only]
		   ...
		   PRA_HOME_TORQUE  	:Longint=$1C;  //Torque-Limit value setting for home move
		   PRA_HOME_EZ_DIR		:Longint=$1D;
		   PRA_HOME_SEARCH_TARGET	:Longint=$1E;  // Select Home move search target signal
		   
		   
           PRA_CURVE		:Longint=$20;	 // Move curve pattern																																									
           PRA_SF       :Longint=$20;	 // Move curve pattern																																									
           ...
           PRA_VM       :Longint=$24;  // Move max velocity																																									
           
           
           PRA_MOVE_RATIO      :Longint=$88;  //Move ratio 
           ...
           PRA_JG_SF      :Longint=$42;	// Jog curve parten(T or s curve;
           ...
           PRA_JG_OFFSET  :Longint=$46;	// Jog offset (For step mode;
           ...
           PRA_SINP_STBT    :Longint=$52;	// Soft INP stable cycle
           ...
           PRA_ENCODER_FILTER  :Longint=$83;	// Encoder filter
           ...
           PRA_KAFF_GAIN    :Longint=$9A;  // Acceleration feedforward Kaff gain
           ...
           PRA_KVFF_GAIN    :Longint=$93;	// Feed forward Kff gain
           PRA_KP_SHIFT     :Longint=$9B; //Proportional control result shift
           PRA_KI_SHIFT     :Longint=$9c; //Integral control result shift 
           PRA_KD_SHIFT     :Longint=$9D; // Derivative control result shift
           PRA_KVFF_SHIFT   :Longint=$9E; //Velocity feed-forward control result shift
           PRA_KAFF_SHIFT   :Longint=$9F; //Acceleration feed-forward control result shift
           
           PRA_PID_SHIFT    :Longint=$A0; //PID control result shift 
           ...
           PRA_SERVO_V_BIAS :Longint=$120;	// Voltage offset
           ...
           PRA_SERVO_V_LIMIT :Longint=$123;	// Voltage saturation output limit
           PRA_ERR_C_LEVEL		:Longint=$124;	// Error counter check level
           PRA_ERR_POS_LEVEL		:Longint=$124;	// Error counter check level
           
           PRA_V_INVERSE		:Longint=$125;	// Output voltage inverse
           PRA_SERVO_V_INVERSE :Longint=$125;	// Output voltage inverse
           ...
           PRA_CONTROL_MODE	:Longint=$141;	// Closed loop control mode
            PRA_CMD_PSF     :Longint=$144;  // (F64) Command Preshaping Path Smooth Factor    

           // Pulser function
            PRA_PSR_IPT_MODE	:Longint=$141;	// Pulser pulse input mode setting
            PRA_PSR_IPT_LOGIC	:Longint=$141;	// Pulser pulse input logic
            PRA_PSR_IPT_DIR	    :Longint=$141;	// Pulser pulse input direction
            PRA_PSR_RATIO_VALUE	:Longint=$141;	// reserved
            PRA_PSR_PDV	        :Longint=$141;	// Pulser ratio by PDV
            PRA_PSR_PMG	        :Longint=$141;	// Pulser ratio by PMG
            PRA_PSR_HOME_TYPE	:Longint=$141;	// Pulser home type
            PRA_PSR_HOME_SPD	:Longint=$141;	// Pulser home maximun speedlimit
            PRA_PSR_ACC     	:Longint=$141;	// reserved
            PRA_PSR_JERK    	:Longint=$141;	// reserved
           ...
           SAMP_MSTS_MDN		:Longint=$0A; //motion status NSTP
           ...
           SAMP_ERROR_POS      :Longint=$23;
           SAMP_PTBUFF_RUN_INDEX:Longint=$24;
           ...
           DEVICE_NAME_PCI_825458       :Longint=9;
            ...
            DEVICE_NAME_AMP_20408C      :Longint=14;
            DEVICE_NAME_PCI_8353       :Longint=15;
            DEVICE_NAME_PCI_8392F      :Longint=16;
            DEVICE_NAME_PCI_C154      :Longint=17;
            DEVICE_NAME_PCI_C154_PLUS      :Longint=18;
            DEVICE_NAME_PCI_8353_RTX      :Longint=19;
            DEVICE_NAME_PCIE_8338       :Longint=20;
            DEVICE_NAME_PCIE_8154      :Longint=21;
            DEVICE_NAME_PCIE_8158      :Longint=22;
            DEVICE_NAME_ENET_EMX100      :Longint=23;
            DEVICE_NAME_PCIE_8334      :Longint=24;
            DEVICE_NAME_PCIE_8332      :Longint=25;
            DEVICE_NAME_PCIE_8331      :Longint=26;
            DEVICE_NAME_PCIE_7856      :Longint=27;
