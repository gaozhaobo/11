...
Declare Function APS_get_curr_sys_ctrl_mode Lib "APS168.dll" (ByVal Axis_ID As Long, Mode As Long ) As Long
...
Declare Function APS_absolute_arc_move_f Lib "APS168.dll" (ByVal Dimension As Long, Axis_ID_Array As Long, Center_Pos_Array As Long, ByVal Max_Arc_Speed As Long, ByVal Angle As Double) As Long
Declare Function APS_relative_arc_move_f Lib "APS168.dll" (ByVal Dimension As Long, Axis_ID_Array As Long, Center_Offset_Array As Long, ByVal Max_Arc_Speed As Long, ByVal Angle As Double) As Long
'
