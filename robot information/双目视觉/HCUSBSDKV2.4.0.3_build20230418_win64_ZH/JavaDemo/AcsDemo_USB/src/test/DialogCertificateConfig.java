...
public class DialogCertificateConfig extends JDialog
{
	...
	public DialogCertificateConfig() 
	{
	...
	public void InitCompoent()
	{
		...
		Info_table.setModel(this.initialTableModel3());
	 ...
	 * 初始化JTable表格
	 */
	public DefaultTableModel initialTableModel3()
	{
		 String tabeTile[];
