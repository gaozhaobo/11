...
Public Const PRB_EMG_MODE As Short = &H101
...
Public Const	TIG_ENC_IPT_MODE0			=   (&H00)      
Public Const  TIG_ENC_IPT_MODE1			=   (&H01)      
Public Const	TIG_ENC_IPT_MODE2			=   (&H02)      
Public Const	TIG_ENC_IPT_MODE3			=   (&H03)      
Public Const	TIG_ENC_IPT_MODE4			=   (&H04)      
Public Const	TIG_ENC_IPT_MODE5			=   (&H05)      
Public Const	TIG_ENC_IPT_MODE6			=   (&H06)      
Public Const	TIG_ENC_IPT_MODE7			=   (&H07)      
Public Const	TIG_ENC_EA_INV0				=   (&H08)      
Public Const	TIG_ENC_EA_INV1				=   (&H09)      
Public Const	TIG_ENC_EA_INV2				=   (&H0A)      
Public Const	TIG_ENC_EA_INV3				=   (&H0B)      
Public Const	TIG_ENC_EA_INV4				=   (&H0C)      
Public Const	TIG_ENC_EA_INV5				=   (&H0D)      
Public Const	TIG_ENC_EA_INV6				=   (&H0E)      
Public Const	TIG_ENC_EA_INV7				=   (&H0F)      
Public Const	TIG_ENC_EB_INV0				=   (&H10)      
Public Const	TIG_ENC_EB_INV1				=   (&H11)      
Public Const	TIG_ENC_EB_INV2				=   (&H12)      
Public Const	TIG_ENC_EB_INV3				=   (&H13)      
Public Const	TIG_ENC_EB_INV4				=   (&H14)      
Public Const	TIG_ENC_EB_INV5				=   (&H15)      
Public Const	TIG_ENC_EB_INV6				=   (&H16)      
Public Const	TIG_ENC_EB_INV7				=   (&H17)      
Public Const	TIG_ENC_SIGNAL_FILITER_EN0	=   (&H28)
Public Const	TIG_ENC_SIGNAL_FILITER_EN1	=   (&H29)
Public Const	TIG_ENC_SIGNAL_FILITER_EN2	=   (&H2A)
Public Const	TIG_ENC_SIGNAL_FILITER_EN3	=   (&H2B)
Public Const	TIG_ENC_SIGNAL_FILITER_EN4	=   (&H2C)
Public Const	TIG_ENC_SIGNAL_FILITER_EN5	=   (&H2D)
Public Const	TIG_ENC_SIGNAL_FILITER_EN6	=   (&H2E)
Public Const	TIG_ENC_SIGNAL_FILITER_EN7	=   (&H2F)
Public Const	TIG_TIMER8_DIR				=   (&H30)      
Public Const	TIG_TIMER8_ITV				=   (&H31)      
Public Const	TIG_CMP0_SRC				=   (&H32)        
Public Const	TIG_CMP1_SRC				=   (&H33)        
Public Const	TIG_CMP2_SRC				=   (&H34)        
Public Const	TIG_CMP3_SRC				=   (&H35)        
Public Const	TIG_CMP4_SRC				=   (&H36)        
Public Const	TIG_CMP5_SRC				=   (&H37)        
Public Const	TIG_CMP6_SRC				=   (&H38)        
Public Const	TIG_CMP7_SRC				=   (&H39)        
Public Const	TIG_TRG0_SRC				=   (&H3A)        
Public Const	TIG_TRG1_SRC				=   (&H3B)        
Public Const	TIG_TRG2_SRC				=   (&H3C)        
Public Const	TIG_TRG3_SRC				=   (&H3D)        
Public Const	TIG_TRG4_SRC				=   (&H3E)        
Public Const	TIG_TRG5_SRC				=   (&H3F)        
Public Const	TIG_TRG6_SRC				=   (&H40)        
Public Const	TIG_TRG7_SRC				=   (&H41)        
Public Const	TIG_TRGOUT0_MAP				=   (&H42)      
Public Const	TIG_TRGOUT1_MAP				=   (&H43)      
Public Const	TIG_TRGOUT2_MAP				=   (&H44)      
Public Const	TIG_TRGOUT3_MAP				=   (&H45)      
Public Const	TIG_TRGOUT4_MAP				=   (&H46)      
Public Const	TIG_TRGOUT5_MAP				=   (&H47)      
Public Const	TIG_TRGOUT6_MAP				=   (&H48)      
Public Const	TIG_TRGOUT7_MAP				=   (&H49)      
Public Const	TIG_TRGOUT0_LOGIC			=   (&H4A)      
Public Const	TIG_TRGOUT1_LOGIC			=   (&H4B)      
Public Const	TIG_TRGOUT2_LOGIC			=   (&H4C)      
Public Const	TIG_TRGOUT3_LOGIC			=   (&H4D)      
Public Const	TIG_TRGOUT4_LOGIC			=   (&H4E)      
Public Const	TIG_TRGOUT5_LOGIC			=   (&H4F)      
Public Const	TIG_TRGOUT6_LOGIC			=   (&H50)      
Public Const	TIG_TRGOUT7_LOGIC			=   (&H51)      
Public Const	TIG_PWM0_PULSE_WIDTH		=   (&H52)    
Public Const	TIG_PWM1_PULSE_WIDTH		=   (&H53)    
Public Const	TIG_PWM2_PULSE_WIDTH		=   (&H54)    
Public Const	TIG_PWM3_PULSE_WIDTH		=   (&H55)    
Public Const	TIG_PWM4_PULSE_WIDTH		=   (&H56)    
Public Const	TIG_PWM5_PULSE_WIDTH		=   (&H57)    
Public Const	TIG_PWM6_PULSE_WIDTH		=   (&H58)    
Public Const	TIG_PWM7_PULSE_WIDTH		=   (&H59)    
Public Const	TIG_PWM0_MODE				=   (&H5A)        
Public Const	TIG_PWM1_MODE				=   (&H5B)        
Public Const	TIG_PWM2_MODE				=   (&H5C)        
Public Const	TIG_PWM3_MODE				=   (&H5D)        
Public Const	TIG_PWM4_MODE				=   (&H5E)        
Public Const	TIG_PWM5_MODE				=   (&H5F)        
Public Const	TIG_PWM6_MODE				=   (&H60)        
Public Const	TIG_PWM7_MODE				=   (&H61)        
Public Const	TIG_TIMER0_ITV				=   (&H62)      
Public Const	TIG_TIMER1_ITV				=   (&H63)      
Public Const	TIG_TIMER2_ITV				=   (&H64)      
Public Const	TIG_TIMER3_ITV				=   (&H65)      
Public Const	TIG_TIMER4_ITV				=   (&H66)      
Public Const	TIG_TIMER5_ITV				=   (&H67)      
Public Const	TIG_TIMER6_ITV				=   (&H68)      
Public Const	TIG_TIMER7_ITV				=   (&H69)      
Public Const	TIG_FIFO_LEVEL0				=   (&H6A)      
Public Const	TIG_FIFO_LEVEL1				=   (&H6B)      
Public Const	TIG_FIFO_LEVEL2				=   (&H6C)      
Public Const	TIG_FIFO_LEVEL3				=   (&H6D)      
Public Const	TIG_FIFO_LEVEL4				=   (&H6E)      
Public Const	TIG_FIFO_LEVEL5				=   (&H6F)      
Public Const	TIG_FIFO_LEVEL6				=   (&H70)      
Public Const	TIG_FIFO_LEVEL7				=   (&H71)      
Public Const	TIG_OUTPUT_EN0				=   (&H72)      
Public Const	TIG_OUTPUT_EN1				=   (&H73)      
Public Const	TIG_OUTPUT_EN2				=   (&H74)      
Public Const	TIG_OUTPUT_EN3				=   (&H75)      
Public Const	TIG_OUTPUT_EN4				=   (&H76)      
Public Const	TIG_OUTPUT_EN5				=   (&H77)      
Public Const	TIG_OUTPUT_EN6				=   (&H78)      
Public Const	TIG_OUTPUT_EN7				=   (&H79)
...
Public Const PRA_SD_DEC = &H7             '// Stop deceleration
...
Public Const PRA_SPEL_POS = &HA           '// EFB position 0
Public Const PRA_EFB_POS1 = &HB           '// EFB position 1
Public Const PRA_SMEL_POS = &HB           '// EFB position 1
...
Public Const PRA_HOME_TORQUE 	= &H1C  '//Torque-Limit value setting for home move
Public Const PRA_HOME_EZ_DIR	= &H1D
Public Const PRA_HOME_SEARCH_TARGET	= &H1E'// Select Home move search target signal
...
Public Const PRA_PT_STP_DO_EN = &H32      '// Disable do when point table stopping.
Public Const PRA_PT_STOP_DO = &H33        '// Set do value when point table stopping.
Public Const PRA_PT_STP_DO = &H33         '// Set do value when point table stopping.
...
Public Const PRA_JG_SF    = &H42          '// Jog curve parten(T or s curve
...
Public Const PRA_JG_OFFSET = &H46           '// Jog offset (For step mode
...
Public Const PRA_SINP_STBT = &H52         '// Soft INP stable cycle
...
Public Const PRA_EGEAR_MASTER  = &H65       '// Select gearing master: 0~63
Public Const PRA_EGEAR_SOURCE = &H66        '// Select gearing source // 0: command position deviation1: feedback position deviation

Public Const PRA_MOVE_RATIO = &H88          '//Move ratio
...
Public Const PRA_ENCODER_FILTER = &H83        '// Encoder filter
...
Public Const PRA_KVFF_GAIN = &H93          '// Velocity feedforward Kff gain


Public Const PRA_KP_SHIFT   = &H9B           '//Proportional control result shift
Public Const PRA_KI_SHIFT   = &H9C           '//Integral control result shift
Public Const PRA_KD_SHIFT   = &H9D           '// Derivative control result shift
Public Const PRA_KVFF_SHIFT = &H9E          '//Velocity feed-forward control result shift
Public Const PRA_KAFF_SHIFT = &H9F          '//Acceleration feed-forward control result shift
Public Const PRA_PID_SHIFT  = &HA0          '//PID control result shift
...
Public Const PRA_SERVO_V_BIAS = &H120     '// Voltage offset
...
Public Const PRA_SERVO_V_LIMIT  = &H123   '// Voltage saturation output limit
Public Const PRA_ERR_C_LEVEL = &H124      '// Error counter check level
Public Const PRA_ERR_POS_LEVEL = &H124     '// Error counter check level
Public Const PRA_V_INVERSE = &H125        '// Output voltage inverse
Public Const PRA_SERVO_V_INVERSE = &H125  '// Output voltage inverse
...
Public Const PRA_CMD_PSF As Short = &144 '(F64) Command Preshaping Path Smooth Factor


' Pulser function
Public Const PRA_PSR_IPT_MODE = &H160 'Pulser pulse input mode setting
Public Const PRA_PSR_IPT_LOGIC = &H161 'Pulser pulse input logic
Public Const PRA_PSR_IPT_DIR = &H162 'Pulser pulse input direction
Public Const PRA_PSR_RATIO_VALUE = &H163 'reserved   
Public Const PRA_PSR_PDV = &H164 'Pulser ratio by PDV
Public Const PRA_PSR_PMG = &H165 'Pulser ratio by PMG
Public Const PRA_PSR_HOME_TYPE = &H166 'Pulser home type
Public Const PRA_PSR_HOME_SPD = &H167 'Pulser home maximun speedlimit
Public Const PRA_PSR_ACC = &H168 'reserved
Public Const PRA_PSR_JERK = &H169 'reserved
...
Public Const SAMP_MSTS_MDN  = &HA        '//motion status NSTP
...
Public Const SAMP_ERROR_POS = &H23
...
Public Const DEVICE_NAME_PCI_825458 = (9)
...
Public Const DEVICE_NAME_AMP_20408C = (14)
Public Const DEVICE_NAME_PCI_8353 	= (15)
Public Const DEVICE_NAME_PCI_8392F 	= (16)
Public Const DEVICE_NAME_PCI_C154 	= (17)
Public Const DEVICE_NAME_PCI_C154_PLUS = (18)
Public Const DEVICE_NAME_PCI_8353_RTX 	= (19)
Public Const DEVICE_NAME_PCIE_8338 	= (20)
Public Const DEVICE_NAME_PCIE_8154 	= (21)
Public Const DEVICE_NAME_PCIE_8158 	= (22)
Public Const DEVICE_NAME_ENET_EMX100 	= (23)
Public Const DEVICE_NAME_PCIE_8334 	= (24)
Public Const DEVICE_NAME_PCIE_8332 	= (25)
Public Const DEVICE_NAME_PCIE_8331 	= (26)
Public Const DEVICE_NAME_PCIE_7856  = (27)
'//'//'//'//'//'//'//'//'//'//'//'//'//'//'//'//'//'//'//'//'//'//'///
...
Public Const TGR_TCMP0_REUSE		= &H7	'// ECAT-4XMO
Public Const TGR_TCMP1_REUSE        = &H8	'// ECAT-4XMO
Public Const TGR_TCMP0_TRANSFER_DONE= &H9	'// ECAT-4XMO
Public Const TGR_TCMP1_TRANSFER_DONE= &HA	'// ECAT-4XMO
...
Public Const OPT_FORCE_ABORT = &H200
