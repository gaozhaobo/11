...
void p2p_example( I32 Axis_ID )
{
	...
	APS_ptp( Axis_ID, OPT_RELATIVE, 1000.0 , 0 );
...
void interpolation_3D_arc_example( I32 *Axis_ID_Array )
{
	...
	F64 EndArray[3]    = { 1000.0 , 1000.0, 1000 * 1.4142135623730950488016887242097 };
	I16 Dir = 0;
	F64 TransPara = 0;
	int i;
...
void gear_example( I32 *Axis_ID_Array )
{
	...
	if( status == 0 )
	{
		...
		APS_start_gear( slaveAxis, 1 ); //Set to gantry mode
	}
...
void ThreadProc_PWM( I32 board_id, I32 channel )
{
	I32 ret = 0;
	I32 Board_ID  = board_id;
