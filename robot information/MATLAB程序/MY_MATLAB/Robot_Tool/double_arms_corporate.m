...
Robot3 = SerialLink(L3,'name','Robot');
...
for i=1:length(t_samples)
   ...
   test_qf_next = test_qf_next+0.01*v_qf';
...
%绘制轨迹点
plot3(points_1(1,:), points_1(2,:), points_1(3,:), 'b.', 'MarkerSize', 6);
xlabel('X轴');
ylabel('Y轴');
zlabel('Z轴');
hold on;
plot3(points_2(1,:), points_2(2,:), points_2(3,:), 'g.', 'MarkerSize', 6);
