...
public class DlgActivateCard extends JDialog 
{
	...
	public DlgActivateCard(String LanEnvironment) 
	{
		setResizable(false);
	...
	public void InitCompoent(String LanEnvironment)
	{
		...
		setSize(520, 312);
		 if(LanEnvironment.contains("en"))
		 {
				...
				JLabel label = new JLabel("operation time：");
				...
				panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "device response",
						TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
				panel.setBounds(10, 51, 484, 212);
				getContentPane().add(panel);
				
				JLabel label_2 = new JLabel("card protocol type：");
				label_2.setBounds(10, 27, 120, 15);
				panel.add(label_2);
				
				JLabel label_3 = new JLabel("serial no len：");
				label_3.setBounds(10, 63, 86, 15);
				panel.add(label_3);
				
				JLabel label_4 = new JLabel("serial no：");
				label_4.setBounds(10, 98, 70, 15);
				panel.add(label_4);
				
				JLabel label_5 = new JLabel("select confirm len：");
				label_5.setBounds(10, 134, 130, 15);
				panel.add(label_5);
				
				JLabel label_6 = new JLabel("select confirm：");
				label_6.setBounds(10, 170, 100, 15);
				panel.add(label_6);
			
				textField_CardProtocol = new JTextField();
				textField_CardProtocol.setBounds(150, 24, 169, 21);
				panel.add(textField_CardProtocol);
				textField_CardProtocol.setColumns(10);
				
				textField_SerialLen = new JTextField();
				textField_SerialLen.setBounds(150, 60, 169, 21);
				panel.add(textField_SerialLen);
				textField_SerialLen.setColumns(10);
				
				textField_Serial = new JTextField();
				textField_Serial.setBounds(150, 95, 169, 21);
				panel.add(textField_Serial);
				textField_Serial.setColumns(10);
				
				textField_VerifyLen = new JTextField();
				textField_VerifyLen.setBounds(150, 131, 169, 21);
				panel.add(textField_VerifyLen);
				textField_VerifyLen.setColumns(10);
				
				textField_SelVerify = new JTextField();
				textField_SelVerify.setBounds(150, 167, 169, 21);
	...
	public void btnActivate(ActionEvent e)
	{
		...
		if(waitTime < 0 || waitTime > 128)
		{
			AcsDemo_USB.WriteLog(HCUsbSDK.ERR_LEVEL, "操作等待时间范围为[0, 128], 0表示一直执行，直到有卡响应");
			return;
		}
		...
		else
		{
			...
			AcsDemo_USB.WriteLog(HCUsbSDK.ERR_LEVEL, "activate failed, error no: " + error);
		}
	}
}
