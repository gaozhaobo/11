...
namespace AcsDemo_USB.Language
{
    class MultiLanguage
    {
        ...
        public static string GetDefaultLanguage()
        {
            ...
            XmlReader reader = new XmlTextReader("../AcsDemo/Language/DefaultLanguage.xml");
        ...
        public static void SetDefaultLanguage(string lang)
        {
            ...
            ds.ReadXml("../AcsDemo/Language/DefaultLanguage.xml");
            DataTable dt = ds.Tables["AcsDemo_USB"];
            dt.Rows[0]["DefaultLanguage"] = lang;
            ds.AcceptChanges();
            ds.WriteXml("../AcsDemo/Language/DefaultLanguage.xml");
        ...
        private static Hashtable ReadXMLText(string frmName, string lang)
        {
            try
            {
                ...
                //判断是否存在该语言的配置文件
                if (!(new System.IO.FileInfo("../AcsDemo/Language/" + lang + ".xml")).Exists)
                {
                    return null;
                }
                else
                {
                    reader = new XmlTextReader("../AcsDemo/Language/" + lang + ".xml");
                }
                XmlDocument doc = new XmlDocument();
                doc.Load(reader);
                XmlNode root = doc.DocumentElement;
