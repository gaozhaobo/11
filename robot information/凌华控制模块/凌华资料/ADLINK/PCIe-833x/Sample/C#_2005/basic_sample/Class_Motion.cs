...
namespace basic_sample
{
    class Class_Motion
    {
        ...
        public static void interpolation_2D_line_example( Int32[] Axis_ID_Array )
        {
            ...
            ret = APS168.APS_motion_io_status(Axis_ID_Array[0]);
            ret = ret >> (Int32)APS_Define.MIO_SVON;
            //servo on
            if (((APS168.APS_motion_io_status(Axis_ID_Array[0]) >> (Int32)APS_Define.MIO_SVON) & 1) == 0)
            {
                APS168.APS_set_servo_on(Axis_ID_Array[0], 1);
                Thread.Sleep(500); // Wait stable.
            }
            //servo on         
            if (((APS168.APS_motion_io_status(Axis_ID_Array[1]) >> (Int32)APS_Define.MIO_SVON) & 1) == 0)
            {
        ...
        public static void interpolation_2D_arc_example( Int32[] Axis_ID_Array )
        {
        ...
        public static void interpolation_3D_arc_example( Int32[] Axis_ID_Array )
        {
	        ...
	        for( i = 0; i < 3; i++ )
	        {
                if (((APS168.APS_motion_io_status(Axis_ID_Array[i]) >> (Int32)APS_Define.MIO_SVON) & 1) == 0)
                {
        ...
        public static void  interpolation_3D_helical_example( Int32[] Axis_ID_Array )
        {
            double[] CenterArray = new double[] { 1000.0 , 1000.0, 0 };
        ...
        public static void contour_2D_example( Int32[] Axis_ID_Array )
        {
            ASYNCALL p = new ASYNCALL();
	        Int16 i;
	        double TransPara = 0;
        ...
        public static void point_table_2D_example(Int32 Board_ID, Int32[] Axis_ID_Array)
        {
        ...
        public static void gear_example(Int32[] Axis_ID_Array )
        {
        ...
        public static Int32 interrupt_example(Int32 Board_ID, Int32 Axis_num)
        {
        ...
        public static void AIO_sample(Int32 Board_ID)
        {
            Int32 Channel_No = 0;
